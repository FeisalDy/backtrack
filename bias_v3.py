...
# - INTERVAL: "5min", "15min", "30min", or "hour"
#
# Available data:
#   5min data: BTC, ETH, DOGE, SOL, ADA (~60 days)
#   15min data: BTC, ETH, DOGE, SOL, ADA (~60 days)
#   30min data: BTC, ETH, DOGE, SOL, ADA (~60 days)
...
# USER PARAMETERS
# -------------------------
SYMBOL = "BTC"  # BTC, ETH, DOGE, SOL, ADA
INTERVAL = "hour"  # "5min", "15min", "30min", or "hour"
