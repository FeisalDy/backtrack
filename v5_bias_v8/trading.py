"""
Trading logic module for V5.
Single Responsibility: Handle trade level calculations and stop checking.
"""
import numpy as np


def calculate_trade_levels(entry_price, atr_val, bias, rr_follow=2.5, atr_sl_mult=2.0):
    """
    Calculate take profit and stop loss levels for a trade using ATR.
