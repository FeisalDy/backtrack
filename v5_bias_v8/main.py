"""
Main orchestrator for V5 backtesting strategy.
Single Responsibility: Coordinate all modules and execute the complete backtest workflow.

V5 STRATEGY (bias_v8 logic):
- Enhanced bias scoring with 7 technical components
- ATR-based stop loss and take profit
- Fixed risk-reward ratio (2.5:1)
...
def main():
    ...
    """
    print("=" * 70)
    print("V5 BACKTEST STRATEGY - BIAS V8 LOGIC")
    print("=" * 70)
